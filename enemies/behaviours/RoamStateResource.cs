...
//	public Vector3 Target
	public override void Process(EnemyBase controlled, bool isActive, double delta) {
		...
		// TODO turn
		var targetAngle = MathF.Atan2(controlled.Velocity.X,controlled.Velocity.Z);		var diff = (float)Mathf.Wrap(targetAngle - controlled.MeshNode.Rotation.Y, -Math.PI, Math.PI);
